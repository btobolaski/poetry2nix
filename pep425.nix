    ...
    let
      ...
      withPlatform =
        ...
        then
          ...
          # See PEP 600 for details.
            (p:
              builtins.match "any|manylinux(1|2010|2014)_${escapeRegex targetMachine}|manylinux_[0-9]+_[0-9]+_${escapeRegex targetMachine}|[0-9]-linux_${escapeRegex targetMachine}" p != null
            )
          else
            (p: p == "any")
        else
      ...
      choose = files:
        let
          ...
          linuxMatches = [ "manylinux1_" "manylinux2010_" "manylinux2014_" "manylinux_" "any" "-linux_"];
